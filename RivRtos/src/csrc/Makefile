...
VCSUCLI=-lvcsucli
LLVM_FLAGS=
RUNTIME=-lvcsnew -lsimprofile -luclinative /mnt/NVME2/synopsys/vcs/W-2024.09-SP1/linux64/lib/vcs_tls.o $(DEPLIBS) 

VCS_SAVE_RESTORE_OBJ=/mnt/NVME2/synopsys/vcs/W-2024.09-SP1/linux64/lib/vcs_save_restore_new.o
...
LDFLAGS= -rdynamic  -Wl,-rpath='$$ORIGIN'/simv.daidir -Wl,-rpath=./simv.daidir -Wl,-rpath=/mnt/NVME2/synopsys/vcs/W-2024.09-SP1/linux64/lib -L/mnt/NVME2/synopsys/vcs/W-2024.09-SP1/linux64/lib 
# Picarchive Flags
...
CFLAGS=$(STDLIB)-w  -pipe -fPIC -O -I/mnt/NVME2/synopsys/vcs/W-2024.09-SP1/include   

CFLAGS_O0=-w  -pipe -fPIC -I/mnt/NVME2/synopsys/vcs/W-2024.09-SP1/include -O0  -fno-strict-aliasing -fno-optimize-sibling-calls   

CFLAGS_CG=-w  -pipe -fPIC -I/mnt/NVME2/synopsys/vcs/W-2024.09-SP1/include -O  -fno-strict-aliasing -fno-optimize-sibling-calls   

CFLAGS_CG_CLIB=-w  -pipe -fPIC -I/mnt/NVME2/synopsys/vcs/W-2024.09-SP1/include -O  -fno-strict-aliasing -fno-optimize-sibling-calls   

CFLAGS_RMAR=-w  -pipe -fPIC -I/mnt/NVME2/synopsys/vcs/W-2024.09-SP1/include -O  -fno-strict-aliasing -fno-optimize-sibling-calls   
...
$(PRODUCT) :  $(LD_VERSION_CHECK)  $(OBJS) $(DOTLIBS) $(DPI_STUB_OBJS) $(PLI_STUB_OBJS) $(CMODLIB) $(SYSC_STUB_LIB) $(DPI_ALLOW_MAIN_SO)  /mnt/NVME2/synopsys/vcs/W-2024.09-SP1/linux64/lib/libvcsnew.so /mnt/NVME2/synopsys/vcs/W-2024.09-SP1/linux64/lib/libsimprofile.so /mnt/NVME2/synopsys/vcs/W-2024.09-SP1/linux64/lib/libuclinative.so /mnt/NVME2/synopsys/vcs/W-2024.09-SP1/linux64/lib/vcs_tls.o /mnt/NVME2/synopsys/vcs/W-2024.09-SP1/linux64/lib/libvcsucli.so  $(VCS_SAVE_RESTORE_OBJ) 
	@touch $(PRODUCT)
